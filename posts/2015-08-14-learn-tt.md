...
open-ended than most of my other posts, if you're interested in seeing
the updated version look [here][github]. Pull requests/issues are more
than welcome on the repository. I hope you learn something from this.*
