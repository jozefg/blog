...
which clearly doesn't prove our goal. We have to start somewhere
though because an empty `{}` is currently a parse error. When we run
JonPRL on this file (C-c C-l if you're in Emacs) you get back
